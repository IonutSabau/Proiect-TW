...
$sql="SELECT product_code, product_name, product_img_name, price FROM produse WHERE category='ktm' AND fandom='ktm'";
...
$sql="SELECT product_code, product_name, product_img_name, price FROM produse WHERE category='accktm' AND fandom='acc'";
