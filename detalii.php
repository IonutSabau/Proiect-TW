...
$sql="SELECT product_code, product_name, product_img_name, price, Detalii FROM produse WHERE product_code=1";
...
<h4><center><b><p style="color:white">Recomandari de produse asemanatoare</p></b></center></h4>
...
$sql="SELECT product_name, product_img_name FROM produse WHERE category='huq' AND fandom='huq' AND product_code>1";
