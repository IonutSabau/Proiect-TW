...
body{
	margin: 0;
	background-image: url("ktmfundal2.jpg");
   	}
#logo{
	padding-top: 0.7%;			
	
	background-image: url("ktmbac.jpg");
	width: 14%;
	height: 13%;
	float: left;
	position: fixed;
...
#myButton{
	-moz-box-shadow: 0px 0px 8px 2px 	#ffff00;
	...
	padding:3px 0px;
	text-decoration:none;
	text-shadow:0px 1px 0px #ff751a;
	margin-bottom:10px;
	width: 35%;
}
...
<div id="logo">
	...
	<ul>
		...
		<li><a href="#palete" > <table><tr><td><img src="ktmlogo2.png" width="50%" /></td>
		<td><i><b><p style="color:white">KTM</p></b></i></td></tr></table></a></li>

		<li><a href="#acc"><table><tr><td><img src="ktmlogo2.png" width="80%"  /></td>
...
<h3><center><b><p style="color:white">KTM OEM</p></b></center></h3>
...
$sql="SELECT product_code, product_name, product_img_name, price,Detalii FROM produse WHERE product_code=9";
...
while($obj = $results->fetch_object())
{
 echo <<< EOT
	...
	<a href="detalii2.php"><p style="color:black" align="center"><b>{$obj->product_name}</b></p></a>
	...
	<p style="color:black" align="left"><b>{$obj->Detalii}</b></p>
EOT;
}
$conn->close();
...
<h4><center><b><p style="color:white">Alte produse recomandate</p></b></center></h4>
...
$sql="SELECT product_code, product_name, product_img_name, price FROM produse WHERE category='ktm' AND fandom='ktm' AND product_code!=9";
