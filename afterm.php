...
#logo{
	...
	background-image: url("amfundal2.jpg");
	width: 14%;
	height: 13%;
	float: left;
	position: fixed;
...
#myButton{
	-moz-box-shadow: 0px 0px 8px 2px 	#8c8c8c;
...
<div id="logo">
	...
	<ul>
		...
		<li><a href="#palete" > <table><tr><td><img src="amlogo.png" width="60%" /></td>
		<td><i><b><p style="color:black">After Market</p></b></i></td></tr></table></a></li>

		<li><a href="#acc"><table><tr><td><img src="amlogo.png" width="100%"  /></td>
		<td><i><b><p style="color:black">&nbsp;Accesorii</p></b></i/></td></tr></table></a></li>

	
		<li><a href="#cart"><table><tr><td><img src="cos.png" width="60%"/></td>
			<td><p style="color:black">&nbsp;Coș de cumpărături</p></td></tr></table></a></li>
...
<span>
	<ul>	
		<li style="float:right;">
			...
			<td><b><p style="color:black;">&nbsp;Logout<p></b></td></tr></table></a>
				</span>
		</li>
		
		<li style="float:right;">
		<a href="view_cart.php"><table><tr><td><img src="cos.png"  style="width:40px;height:40px;" /></td>
		<td><b><p style="color:black;">&nbsp;Checkout&nbsp;</p></b></td></tr></table></a>
...
if(isset($_SESSION["cart_products"]) && count($_SESSION["cart_products"])>0)
{
	...
	echo '<h3 style="color:black;"><b>Coșul tău de cumpărături</b></h3>';
	echo '<form method="post" action="cart_update.php">';
	echo '<table width="100%"  cellpadding="6" cellspacing="0">';
	echo '<thead><tr><th>Cantitate</th><th>Categorie</th><th>Nume</th><th>Șterge</th></thead>';
	echo '<tbody>';
	...
	echo '<td><a href="view_cart.php" id="myButton" style="width: 25%; padding-left: 8px;">Finalizare</a>';
	echo '</td>';
	echo '</tr>';
	echo '</tbody>';
	echo '</table>';
...
<h3><center><b><p style="color:black">After Market</p></b></center></h3>
...
$sql="SELECT product_code, product_name, product_img_name, price FROM produse WHERE category='am' AND fandom='am'";
...
while($obj = $results->fetch_object())
{
 echo <<< EOT
	...
	<center><b><img src="{$obj->product_img_name}"style="width:300px;height:200px;"></b></center>
	<p style="color:black" align="center"><b>{$obj->product_name}</b></p>
...
<h4><center><b><p style="color:black">Accesorii</p></b></center></h4>
...
$sql="SELECT product_code, product_name, product_img_name, price FROM produse WHERE category='accam' AND fandom='acc'";
...
while($obj = $results->fetch_object())
{
 echo <<< EOT
	...
	<p align="center" style="font-size: 1.2em;"><b>{$currency}{$obj->price}</p> </p>
	<input type="hidden" name="product_code" value="{$obj->product_code}" />
	<input type="hidden" name="type" value="add" />
	<input type="hidden" name="return_url" value="{$current_url}" />
	<div align="center">
